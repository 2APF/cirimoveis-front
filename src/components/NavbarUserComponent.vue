...
const userAvatar = computed(() => 
  'https://ui-avatars.com/api/?name=' + encodeURIComponent(userName.value) + '&background=dc3545&color=fff&size=32&rounded=true'
)
...
const announceProperty = async () => {
  ...
  try {
    ...
    await routerInstance.push({ name: 'app.announce' })
  } finally {
